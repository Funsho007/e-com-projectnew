...
ActiveRecord::Schema[7.1].define(version: 2024_07_18_152950) do
...
NoMethodError in Admin::ProvincesController#create
undefined method `GST' for an instance of Province
Extracted source (around line #489):
...
Rails.root: /home/ooke0392703/projects/finest
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
