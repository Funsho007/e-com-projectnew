...
unless Planet.exists?(name: planets_data['name'])
...
people_data.each do |person|
  Person.create!(
    ...
    species_id: person['species'][0]&.split('/').last.to_i
  )
end
...
10.times do
  ...
  unless Planet.exists?(name: planet_name)
