class CheckoutController < ApplicationController
  ...
  def create
    ...
    session = Stripe::Checkout::Session.create({
      ...
      mode: 'payment',
      success_url: "https://c9a9-24-78-13-91.ngrok-free.app/checkout/success?session_id={CHECKOUT_SESSION_ID}",
      cancel_url: "https://c9a9-24-78-13-91.ngrok-free.app/checkout/cancel",
      metadata: {
